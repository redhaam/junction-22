...
class CRUDFeedback(CRUDBase[Feedback, FeedbackCreate, FeedbackUpdate]):
    def get(self, db: Session, expert_id: int, project_id: int) -> Feedback:
    ...
    def update(
        ...
        *,
        db_obj: Any,
        obj_in: Union[FeedbackUpdate, Dict[str, Any]]
    ) -> Feedback:
    ...
    def remove(self, db: Session, *, expert_id: int, project_id: int) -> Feedback:
